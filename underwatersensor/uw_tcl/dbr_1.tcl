...
set opt(nn)	        400	;# number of nodes 
...
set opt(tr)		"dbr_1.tr"	;# trace file
set opt(datafile)	"dbr_1.data"
set opt(nam)            "dbr_1.nam"  ;# nam file
...
for {set i 2} { $i < $opt(nn) } { incr i } {
	...
	$node_($i) move  ;#its a command of underwatersensornode class 
...
$ns_ at $opt(stop2).003  "$god_ compute_energy" ;#printf to console and fprintf to datafile
